...
Answer.addResponse = function(o, cb){
  console.log('o.formID>>>>>>>>>>>>>>', o.formID);
  console.log('o.responses>>>>>>>>>>>>>>', o.responses);
  Answer.findByFormId(o.formID.toString(), function(err, answer){
    console.log('answer>>>>>>>>>>>>>>', answer);
    answer.responses.push(o.responses);
    Answer.collection.update({formId:answer.formId}, {$set:{responses:answer.responses}}, function(){
      cb(err, answer);
    });
  });
};
